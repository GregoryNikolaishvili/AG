...
public class SensorRecyclerListAdapter extends RecyclerView.Adapter<ItemViewHolder> implements ItemTouchHelperAdapter {

    public SensorRecyclerListAdapter() {
    }
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        ...
        ChaWidget w = AquaControllerData.Instance.createSensorWidget(ll.getContext(), position, false);
        if (w != null) {
    ...
    public int getItemCount() {
        return AquaControllerData.SENSOR_COUNT;
    }
