...
import ge.altasoft.gia.ag.classes.LogTHItem;
...
public class LogActivityTH2 extends ChaActivity {
    ...
    private void RequestLog(int wd) {
        switch (scope) {
            case BoilerSensor:
                publish("aquagod/hub/getlog", "boiler_".concat(String.valueOf(wd)), false);
                break;
            case RoomSensor:
                publish("aquagod/hub/getlog", "room_".concat(String.valueOf(wd)), false);
                break;
        }
    }
