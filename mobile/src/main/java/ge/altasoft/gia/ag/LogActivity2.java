...
import ge.altasoft.gia.ag.classes.LogTwoValueItem;
...
public class LogActivity2 extends ChaActivity {
    ...
    private void RequestLog(int wd) {
        switch (scope) {
            case WindSensor:
            case WindDirSensor:
                publish("aquagod/hub/getlog", "wind_".concat(String.valueOf(wd)), false);
            case RainSensor:
                publish("aquagod/hub/getlog", "rain_".concat(String.valueOf(wd)), false);
            case PressureSensor:
                publish("aquagod/hub/getlog", "pres_".concat(String.valueOf(wd)), false);
                break;
            case WaterLevelSensor:
                publish("aquagod/hub/getlog", "tank_".concat(String.valueOf(wd)), false);
                break;
        }
    }
